...
[![Version](https://img.shields.io/badge/Version-0.0.5-blue)](https://github.com/ItsNotSkyeZ/EndlessCoinflip/releases)
...
## Installation
1. Download the latest jar from [Releases](https://github.com/ItsNotSkyeX/EndlessCoinflip/releases)
...
Run `/cf reload` after making changes — no restart needed.
...
## Building
```bash
git clone https://github.com/ItsNotSkyeX/EndlessCoinflip.git
cd EndlessCoinflip
mvn clean package
```
...
- [ ] Custom built-in economy (no Vault required)
...
[Spigot Page](https://www.spigotmc.org/resources/endlesscoinflip-pvp-coinflip-with-bot-battles-stats-1-21.137052)
